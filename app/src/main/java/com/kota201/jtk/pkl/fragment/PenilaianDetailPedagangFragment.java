...
import com.kota201.jtk.pkl.DetailPedagangActivity;
...
public class PenilaianDetailPedagangFragment extends Fragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DetailPedagangActivity activity = (DetailPedagangActivity) getActivity();
