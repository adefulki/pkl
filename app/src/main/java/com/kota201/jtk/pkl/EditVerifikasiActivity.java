...
public class EditVerifikasiActivity extends AppCompatActivity {
        ...
        if(role==1){
            try {
                ...
                if (statusValid){
                    ...
                    this.finish();
                    startActivity(new Intent(EditVerifikasiActivity.this, SettingAkunPedagang.class));
                }else{
            ...
            try {
                ...
                statusValid = jObj.getBoolean("statusValid");
                if (statusValid){
                    startActivity(new Intent(EditVerifikasiActivity.this, SettingAkunPembeli.class));
                }else{
    ...
    public void kirimUlangKodeAkses(){
        ProgressDialog progressDialog = new ProgressDialog(EditVerifikasiActivity.this,
